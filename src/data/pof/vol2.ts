...
// Volume 2 of the production book — releases 18–165. Spoken text only.
...
export const vol2: PofEpisode[] = [
  {
    id: 'pof-m002',
    seq: 18,
    title: "EP 18 · The Bank That Lost Its Customers' Money for a Month",
    body: `[EP 18 · ~90s · slow burn]
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m003',
    seq: 26,
    title: 'EP 26 · The Migration Weekend That Broke a Bank',
    body: `[EP 26 · ~90s · countdown thriller]

A bank moved every customer to a brand new system in one weekend. On Monday, people logged in... and saw **other people's money**. This is The Point of Failure, episode twenty six.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m005',
    seq: 36,
    title: 'EP 36 · One Trader, One Typo, One Continent',
    body: `[EP 36 · ~75s · fast, sharp]

One trader meant to sell **fifty eight million**. The system briefly held an order for **four hundred forty four billion**. This is The Point of Failure, episode thirty six.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m006',
    seq: 43,
    title: 'EP 43 · The $100 Billion That Never Existed',
    body: `[EP 43 · ~90s · disbelief escalating]

A payroll mistake created **a hundred billion dollars** of stock that did not exist. And then employees started selling it. This is The Point of Failure, episode forty three.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m007',
    seq: 50,
    title: 'EP 50 · The $6 Billion Sent While the Boss Was on Holiday',
    body: `[EP 50 · ~60s · wry, tight]

A junior trader wired **six billion dollars** by mistake. His boss was on holiday. This is The Point of Failure, episode fifty.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m008',
    seq: 55,
    title: "EP 55 · The ATMs That Ate Japan's Bank Cards",
    body: `[EP 55 · ~90s · mounting dread]

Thousands of cash machines across Japan swallowed people's bank cards on the same day. And **kept them**. This is The Point of Failure, episode fifty five.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m009',
    seq: 62,
    title: "EP 62 · The Day the Market Didn't Open",
    body: `[EP 62 · ~90s · precision thriller]

The third largest stock market on earth went silent for an entire day. The backup was healthy. It just **never got the call**. This is The Point of Failure, episode sixty two.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m011',
    seq: 70,
    title: 'EP 70 · The Biggest IPO in History Meets a Race Condition',
    body: `[EP 70 · ~90s · tense, made simple]

The biggest tech IPO in history stalled because the software kept trying to hit a target that moved every time it aimed. This is The Point of Failure, episode seventy.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m012',
    seq: 75,
    title: 'EP 75 · The Exchange That Crashed Its Own IPO',
    body: `[EP 75 · ~60s · dark comedy, brisk]

A stock exchange IPO'd on itself. Its own software crashed its own stock in seconds. This is The Point of Failure, episode seventy five.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m013',
    seq: 82,
    title: 'EP 82 · A Trillion Dollars in 36 Minutes',
    body: `[EP 82 · ~90s · big canvas, eerie]

On a random Thursday afternoon, **a trillion dollars** vanished from the US stock market in about half an hour. Then most of it came back. This is The Point of Failure, episode eighty two.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m014',
    seq: 89,
    title: 'EP 89 · The Day Everyone Thought It Was an Attack',
    body: `[EP 89 · ~75s · mystery structure]

The New York Stock Exchange froze. United grounded its planes. The Wall Street Journal went dark. Same day. Same morning. Everyone thought — **attack**. This is The Point of Failure, episode eighty nine.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m015',
    seq: 97,
    title: 'EP 97 · The Backup That Was Left Running',
    body: `[EP 97 · ~75s · procedural, crisp]

The New York Stock Exchange opened one morning already broken, because of something **left switched on overnight**. This is The Point of Failure, episode ninety seven.
