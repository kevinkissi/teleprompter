...
// Volume 3 of the production book — releases 16–169. Spoken text only.
...
export const vol3: PofEpisode[] = [
  {
    id: 'pof-m050',
    seq: 16,
    title: 'EP 16 · 37 Seconds',
    body: `[EP 16 · ~90s · countdown, cinematic]

Europe spent a decade building its new rocket. It flew for **thirty seven seconds**. The bug had been asleep in the code for years. This is The Point of Failure, episode sixteen.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m051',
    seq: 29,
    title: 'EP 29 · The Most Expensive Punctuation Mark in History',
    body: `[EP 29 · ~75s · storyteller, wry]

NASA lost a spacecraft because of one missing punctuation mark. This is The Point of Failure, episode twenty nine.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m056',
    seq: 35,
    title: 'EP 35 · The Clock That Drifted',
    body: `[EP 35 · SERIOUS — measured, low energy, no smile]

A missile defense system missed, because of how computers store the number zero point one. Twenty eight soldiers died. This is The Point of Failure, episode thirty five.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m052',
    seq: 45,
    title: 'EP 45 · Two Teams, Two Unit Systems, One Dead Spacecraft',
    body: `[EP 45 · ~75s · slow reveal]

A three hundred million dollar spacecraft flew ten months to Mars and missed, because two teams' software spoke different measurement languages. This is The Point of Failure, episode forty five.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m053',
    seq: 53,
    title: 'EP 53 · The Landing That Felt Like Landing',
    body: `[EP 53 · ~60s · quiet tragedy]

A Mars lander shut off its own engines **forty meters** above the ground... because deploying its legs felt like landing. This is The Point of Failure, episode fifty three.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m054',
    seq: 64,
    title: 'EP 64 · The Rover Rebooting Itself on Mars',
    body: `[EP 64 · ~75s · rescue story, warm]

NASA's rover started crash looping on Mars, **eighteen days** into the mission. The nearest IT support was two hundred fifty million kilometers away. This is The Point of Failure, episode sixty four.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    ...
    seq: 72,
    title: 'EP 72 · 1202',
    body: `[EP 72 · ~90s · reverent, thrilling]

Three minutes before humans first landed on the Moon, their computer started throwing alarms. The landing continued. On purpose. This is The Point of Failure, episode seventy two.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m057',
    seq: 80,
    title: 'EP 80 · The Jets That Flew Into Tomorrow',
    body: `[EP 80 · ~60s · astonishment, controlled]

The most advanced fighter jets on earth crossed the international date line... and their software gave up. This is The Point of Failure, episode eighty.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m058',
    seq: 88,
    title: 'EP 88 · Divide by Zero, Dead in the Water',
    body: `[EP 88 · ~60s · wry, tight]

A warship was reportedly left drifting at sea because somebody typed **a zero**. This is The Point of Failure, episode eighty eight.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m059',
    seq: 98,
    title: 'EP 98 · Please Reboot Your Airplane',
    body: `[EP 98 · ~60s · deadpan escalating]

Regulators once ordered airlines to turn their planes off and on again. **Legally.** This is The Point of Failure, episode ninety eight.
