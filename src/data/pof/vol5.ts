...
// Volume 5 of the production book — releases 19–172. Spoken text only.
...
export const vol5: PofEpisode[] = [
  {
    id: 'pof-m029',
    seq: 19,
    title: "EP 19 · The Morning the Internet's Address Book Failed",
    body: `[EP 19 · ~90s · modern epic]
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m030',
    seq: 28,
    title: 'EP 28 · The Day AWS Hit an Invisible Ceiling',
    body: `[EP 28 · ~75s · detective]

Amazon added servers to make a service stronger. The addition itself knocked it over, along with logins and monitoring for a big slice of the internet. This is The Point of Failure, episode twenty eight.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m031',
    seq: 40,
    title: 'EP 40 · Amazon vs Amazon',
    body: `[EP 40 · ~75s · irony forward]

The outage was so deep inside Amazon that Amazon's own warehouses reportedly stopped. During the holidays. This is The Point of Failure, episode forty.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m032',
    seq: 47,
    title: 'EP 47 · The First Cloud Crisis',
    body: `[EP 47 · ~90s · historical, formative]

The first great cloud outage lasted days, and the thing that spread it was the safety mechanism. This is The Point of Failure, episode forty seven.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m033',
    seq: 52,
    title: "EP 52 · The Cloud That Couldn't Count to February 29",
    body: `[EP 52 · ~60s · wry, tight]

Microsoft's cloud went down because its software believed **February 29, 2013** was a real date. This is The Point of Failure, episode fifty two.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m034',
    seq: 61,
    title: 'EP 61 · When the Front Door Is the Only Door',
    body: `[EP 61 · ~75s · structural, brisk]

Microsoft's front door for the internet jammed, and behind it stood Office, Xbox, airlines, and thousands of businesses, all knocking. This is The Point of Failure, episode sixty one.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m035',
    seq: 71,
    title: 'EP 71 · Nine Hours Without the Office',
    body: `[EP 71 · ~75s · recent history, careful]

For **nine hours**, a huge share of the world's offices had no email, no chat, no files, and, quietly worst of all, degraded security dashboards. All at once. This is The Point of Failure, episode seventy one.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m036',
    seq: 76,
    title: 'EP 76 · The Day Every Google Login Died',
    body: `[EP 76 · ~60s · tight, structural]

For about forty five minutes, the internet's biggest login button did nothing, worldwide. The killer was a **cost saving robot**. This is The Point of Failure, episode seventy six.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m037',
    seq: 85,
    title: 'EP 85 · The Day Google Flagged the Entire Internet',
    body: `[EP 85 · ~60s · comedy of scale]

For about an hour, Google told everyone that every website on the internet might harm their computer. **Every. Single. One.** This is The Point of Failure, episode eighty five.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m038',
    seq: 92,
    title: 'EP 92 · When Email Was Down, and the World Noticed It Cared',
    body: `[EP 92 · ~60s · nostalgic, structural]

In 2009, email went down for **a hundred minutes** and it made global news. That reaction was the real story. This is The Point of Failure, episode ninety two.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m039',
    seq: 100,
    title: 'EP 100 · One Customer, One Setting, No Internet',
    body: `[EP 100 · ~75s · thriller compression]

Somewhere, one customer changed **one setting**. Within seconds, most of the internet's front page returned errors, including an entire government's website. This is The Point of Failure, episode one hundred.
