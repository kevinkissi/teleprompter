...
// Volume 7 of the production book — releases 22–167. Spoken text only.
...
export const vol7: PofEpisode[] = [
  {
    id: 'pof-m097',
    seq: 22,
    title: "EP 22 · The Halloween With No Hershey's",
    body: `[EP 22 · ~75s · seasonal thriller]

The candy was made. The warehouses were full. And a hundred million dollars of Halloween... never left the building. This is The Point of Failure, episode twenty two.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m111',
    seq: 24,
    title: 'EP 24 · Six Enrollments',
    body: `[EP 24 · ~90s · rescue epic]

Millions of Americans tried to use the website on day one. It completed **six enrollments**. Six. And the rescue changed government software forever. This is The Point of Failure, episode twenty four.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m098',
    seq: 37,
    title: 'EP 37 · The ERP Project That Killed the Company',
    body: `[EP 37 · ~90s · corporate tragedy]

A five billion dollar company installed new software, priced its future on the savings... and was gone in two years. Sold for **eighty million**. This is The Point of Failure, episode thirty seven.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m113',
    seq: 41,
    title: "EP 41 · The Payroll That Ate Canada's Budget",
    body: `[EP 41 · ~75s · bureaucratic tragedy]

A government built a payroll system to save **seventy million a year**. It has **cost billions**, and some employees waited years to be paid correctly. This is The Point of Failure, episode forty one.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m099',
    seq: 48,
    title: "EP 48 · 'This Is What I Get for $400 Million?'",
    body: `[EP 48 · ~60s · quote driven, brisk]

Nike's new software decided the world wanted the wrong sneakers. A hundred million dollars later, the CEO reviewed it in one sentence. This is The Point of Failure, episode forty eight.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m112',
    seq: 49,
    title: 'EP 49 · The Horizon Scandal',
    body: `[SERIOUS — measured, low energy, no smile]

This is the story of what happens when an institution decides its software cannot be wrong — and its people must be. It is the heaviest story in this series that is not about a plane. This is The Point of Failure, episode forty nine.
...
Every failure has a story. Every story was preventable. I'm Kevin.`,
  },
  {
    id: 'pof-m100',
    seq: 59,
    title: 'EP 59 · Half a Billion Euros, Then Back to the Old System',
    body: `[EP 59 · ~75s · autopsy of a mismatch]

Seven years. Around **half a billion euros**. And in the end, the company switched its old software back on. This is The Point of Failure, episode fifty nine.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m114',
    seq: 66,
    title: 'EP 66 · The AU$1.2 Billion Payslip',
    body: `[EP 66 · ~60s · inquiry driven]

A payroll project contracted in the tens of millions ended up costing **one point two billion dollars** — and the people it failed to pay were nurses. This is The Point of Failure, episode sixty six.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m101',
    seq: 73,
    title: 'EP 73 · The Rollout That Ended Up in Court',
    body: `[EP 73 · ~60s · compact escalation]

A makeup company's software rollout went so wrong that its own shareholders took it to court. This is The Point of Failure, episode seventy three.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m117',
    seq: 74,
    title: 'EP 74 · Grades by Postcode',
    body: `[EP 74 · ~75s · youth stakes, kinetic]

In 2020, a computer decided hundreds of thousands of students' exam grades — using their schools' pasts. Four days of teenagers in the street overturned it. This is The Point of Failure, episode seventy four.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m115',
    seq: 77,
    title: 'EP 77 · Robodebt',
    body: `[SERIOUS — measured, low energy, no smile]

A government automated its debt collection with one line of flawed math, raised nearly half a million unlawful debts against its own citizens... and kept going after being warned. This is The Point of Failure, episode seventy seven.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m102',
    seq: 84,
    title: 'EP 84 · Target Canada',
    body: `[EP 84 · ~90s · business epic, human]

A retail giant opened a hundred thirty three stores in two years, and lost the whole country to empty shelves, because the data underneath was junk. This is The Point of Failure, episode eighty four.
...
Every failure has a story. Every story was preventable. I'm Kevin. See you at the next one.`,
  },
  {
    id: 'pof-m103',
    seq: 95,
    title: 'EP 95 · Suing Over the Demo',
    body: `[EP 95 · ~60s · courtroom curiosity]

A Fortune 500 company sued its software vendor with an extraordinary claim — the demo we bought... allegedly wasn't real. This is The Point of Failure, episode ninety five.
